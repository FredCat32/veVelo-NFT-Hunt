...
// console.log(data.sell_order.usd_price);

// let nft_metadata = data.results[0].image;
// let parsed_nft_metadata = nft_metadata.split(",");
// let coded_string = parsed_nft_metadata[1];
...
// sellOrder = data.results[0].sell_order.usd_price;
...
// let margin = (sellOrder / veloValue) * 100;
// console.log(margin);

// if (100 - margin > 30) {
//   console.log("Profit");
//   if (1 - veloValue / sellOrder < 35) {
//     console.log(1 - veloValue / sellOrder);
//     console.log("Profit");
//   }
// }
